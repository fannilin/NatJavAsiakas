	...
	<form id="tiedot">
		<table>
			...
			<tr>
				...
				<th colspan= "3" class="oikealle"><a href="listaaasiakas.jsp" id="takaisin">Takaisin listaukseen</a></th>
			</tr>
			<tr>
				<th>Etunimi</th>
				<th>Sukunimi</th>
...
function lisaaTiedot(){	
	...
	.then( function (responseJson) {
		...
		if(vastaus==0){
			document.getElementById("ilmo").innerHTML= "Asiakkaan lisääminen epännistui";
      	}else if(vastaus==1){	        	
